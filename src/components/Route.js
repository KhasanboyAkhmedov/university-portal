...
import SubjectDetails from "./university/Courses/SubjectDetails";
import SubjectEdit from "./university/CourseCRUD/SubjectEdit";
import CourseDetails from './university/Courses/CourseDetails';
import CourseDetailsCs from "./university/CourseDetails/CourseDetails-cs";
...
const Routes = [
    ...
    {
        path: "/courseDetails-cs",
        name: 'courseDetailsCS',
        exact: true,
        pageTitle: "courseDetailsCS",
        component: CourseDetailsCs
    },
    {
        path: "/departments",
        name: 'departments',
