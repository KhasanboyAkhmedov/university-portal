                            ...
                            <div className="notification d-flex">
                                <div className={`dropdown d-flex${languageMenu ? ' show' : ''}`}>
                                    ...
                                    <div className={`dropdown-menu dropdown-menu-right dropdown-menu-arrow${languageMenu ? ' show dLang' : ''}`}>
                                        ...
                                        <div className="dropdown-divider"></div>
                                        <span className="dropdown-item" >
                                            <img className="w20 mr-2" src="../assets/images/flags/ru.svg" alt="avatar" />Russian
											</span>
                                        <span className="dropdown-item" >
                                            <img className="w20 mr-2" src="../assets/images/flags/uz.svg" alt="avatar" />Uzbek
											</span>
                                    </div>
                                </div>
                                ...
                                {/* Here is the button to the profile section */}
